...
namespace PrintBoxMain.UserControls
{
    ...
    {
        ILog log = LogManager.GetLogger(typeof(DocView));
        ...
        public DocView()
        {
            ...
            resources = new ComponentResourceManager(typeof(DocView));
        ...
        public void EnableNavigationButtons(bool flag)
        {
            if (flag)
            {
                ...
                btnScrollUp.NormalImage = ((System.Drawing.Image)(ResourcesMessages.scroll_button_down));
                btnScrollDown.NormalImage = ((System.Drawing.Image)(ResourcesMessages.scroll_button_up));
            ...
            else
            {
                ...
                btnScrollUp.NormalImage = ((System.Drawing.Image)(ResourcesMessages.scroll_button_down_disabled));
                btnScrollDown.NormalImage = ((System.Drawing.Image)(ResourcesMessages.scroll_button_up_disabled));
        ...
        {
            PrintBoxApp.instance.sessionInfo.documentWrapper.SetPos(this);
            UpdatePageNumber();
            LoadPrintOptions();
